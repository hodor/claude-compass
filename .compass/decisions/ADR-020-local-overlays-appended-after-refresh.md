...
- **D-04: `CLAUDE.md` is never read, written, or moved by any Compass command.** It is already untouched; a test now pins it so no future change can quietly break the guarantee the human named first.
