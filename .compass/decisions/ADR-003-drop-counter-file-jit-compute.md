...
Documented as a single rule in `obsidian/SKILL.md` "File Naming" section. Every skill that creates a numbered artifact references the rule rather than re-implementing it.
