...
- **Capability awareness decays as the system grows** - the more Compass can do, the smaller the fraction the human remembers unprompted. Every capability therefore needs an answer to "how does this reach the human": surfaced as a suggestion at its trigger, run automatically, or consciously left callable-only. Nothing ships assuming it will be remembered. [[SPEC-017-capabilities-are-reachable-and-measured]], [[SPEC-022-vault-organized-per-domain]].
