...
- [x] RESEARCH round 2 (2026-08-08): [[RESEARCH-test-quality-craft-and-practice]] (test-design craft + AI-practice primary sources; Anthropic names test-tampering, commit-failing-tests-first checkpoint, fresh-context split measured by AgentCoder). SPEC-013 D-03..D-06 recorded.
...
- [ ] BUILD PLAN-007 Phase A (in progress): TASK-052 checkpoint CLI (L) + TASK-065 fleet census (S, independent) first; then 053 test-design skill, 054 tester.md, 055 build flow, 056 builder+methodology. Phase B entry gated on 065's result.
