...
- [ ] NEXT: validator run over PLAN-007 (optional final gate), fleet distribution of v0.5.x with the test-quality release, SubagentStop typed-signal fix ([[backlog]]), SPEC-011 pipeline, SPEC-006 hosts.
