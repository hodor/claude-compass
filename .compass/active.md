...
- [x] FLEET DISTRIBUTION v0.6.0 (2026-08-08): 43/43 vaults doctor-clean; per-project git commits of Compass-owned paths only; 28 pushed to their remotes. Not pushed: 7 no-git projects, 2 no-remote, 1 all-paths-gitignored (iwyc-unreal), 4 push-rejected (3 ue5-editor-mcp checkouts + wt-spec056 behind their remotes - need a human pull/rebase decision; pg-jira-exporter's remote no longer exists).
