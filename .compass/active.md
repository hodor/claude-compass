...
- [x] TASK-084: vision skill - only the unit question, plain words, once (M, after 085) - spec-list step judges root-spec-vs-workspace from what the human said, acts via `compass make-unit <name> --apply --reason`, never asks; notice is one plain sentence per affected need, silenceable, states reversibility; net line count -2
