...
- [x] TASK-093: doctor reconciles the worker ledger - complexity: S, depends_on: TASK-091, files: [plugin/cli/commands/doctor.py, plugin/cli/tests/test_doctor.py], decisions: [ADR-013-detached-worker-quiet-fallback/D-10]
...
- [x] TASK-095: the balanced-tier re-fire, then fleet distribution (v0.8.0) - complexity: M, depends_on: TASK-099, files: [plugin/.claude-plugin/plugin.json, bench/scripts/fleet_update.py], decisions: [ADR-013-detached-worker-quiet-fallback/D-05, ADR-013-detached-worker-quiet-fallback/D-09]
