...
Approved 2026-08-28 by Roger's blanket go ("don't ask"); stations collapsed into the main thread on that instruction - tests still written adversarially before the implementation.
