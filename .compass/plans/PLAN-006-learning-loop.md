...
- [x] TASK-036: `capturelib` - state, counters, signals, deterministic due-check - complexity: M, depends_on: none, files: [plugin/cli/capturelib.py, plugin/cli/tests/test_capturelib.py], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
...
- [x] TASK-037: `compass capture-signal --hook` replaces the SubagentStop agent hook - complexity: M, depends_on: TASK-036, files: [plugin/cli/commands/capture_signal.py, plugin/cli/maincli.py, plugin/cli/tests/test_capture_commands.py], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
...
- [ ] TASK-038: `compass capture-check --hook` - the Stop-hook trigger - complexity: L, depends_on: TASK-036, files: [plugin/cli/commands/capture_check.py, plugin/cli/maincli.py, plugin/cli/tests/test_capture_commands.py], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
...
- [ ] TASK-039: Capture trace log and `compass capture-stats` - complexity: M, depends_on: TASK-036, files: [plugin/cli/capturelib.py, plugin/cli/commands/capture_stats.py, plugin/cli/maincli.py, plugin/cli/commands/sync.py, plugin/cli/tests/test_capture_commands.py, plugin/cli/tests/test_sync.py], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
...
- [ ] TASK-040: Record signals from the vault-write path - complexity: S, depends_on: TASK-036, files: [plugin/cli/commands/sync.py, plugin/cli/tests/test_sync.py], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
...
- [ ] TASK-041: Generalize `extract-lessons` to opportunity inputs - complexity: M, depends_on: TASK-038, files: [plugin/skills/extract-lessons/SKILL.md], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-02, SPEC-012-learning-loop/D-03]
...
- [ ] TASK-042: Anti-list gains the three hermes skip-list buckets - complexity: S, depends_on: none, files: [plugin/skills/lesson-write/SKILL.md, plugin/skills/extract-lessons/SKILL.md], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
...
- [ ] TASK-043: Hook cutover to command hooks - complexity: M, depends_on: TASK-037, TASK-038, TASK-041, files: [plugin/hooks/hooks.json, plugin/skills/build/SKILL.md], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-02, SPEC-012-learning-loop/D-03]
...
- [ ] TASK-044: Refresh the local install and observe one live firing - complexity: M, depends_on: TASK-043, files: [.claude/cli/, .claude/skills/, .claude/hooks/hooks.json], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
...
- [ ] TASK-045: `compass doctor` - complexity: M, depends_on: TASK-043, files: [plugin/cli/commands/doctor.py, plugin/cli/maincli.py, plugin/cli/tests/test_doctor.py], decisions: [SPEC-012-learning-loop/D-01]
...
- [ ] TASK-047: `lessonslib` and `compass lessons` - complexity: M, depends_on: TASK-044, files: [plugin/cli/lessonslib.py, plugin/cli/commands/lessons.py, plugin/cli/maincli.py, plugin/cli/tests/test_lessonslib.py], decisions: [SPEC-012-learning-loop/D-02, SPEC-012-learning-loop/D-04]
