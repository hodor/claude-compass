...
- [ ] TASK-036: `capturelib` - state, counters, signals, deterministic due-check - complexity: M, depends_on: none, files: [plugin/cli/capturelib.py, plugin/cli/tests/test_capturelib.py], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
