...
- [ ] TASK-037: `compass capture-signal --hook` replaces the SubagentStop agent hook - complexity: M, depends_on: TASK-036, files: [plugin/cli/commands/capture_signal.py, plugin/cli/maincli.py, plugin/cli/tests/test_capture_commands.py], decisions: [SPEC-012-learning-loop/D-01, SPEC-012-learning-loop/D-03]
