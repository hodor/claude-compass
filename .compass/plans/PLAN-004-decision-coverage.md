...
- [ ] TASK-022: `strip_fenced_code` in vaultlib - complexity: S, depends_on: none, files: [plugin/cli/vaultlib.py, plugin/cli/tests/test_vaultlib.py], decisions: [ADR-007-decision-coverage-mechanism/D-03]
...
- [ ] TASK-024: Parser test corpus drawn from the real vault - complexity: M, depends_on: TASK-023, files: [plugin/cli/tests/fixtures/decisions/, plugin/cli/tests/test_decision_corpus.py], decisions: [ADR-007-decision-coverage-mechanism/D-03, ADR-007-decision-coverage-mechanism/D-08, SPEC-007-decision-coverage-tracing/D-01, SPEC-007-decision-coverage-tracing/D-02]
