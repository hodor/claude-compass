...
- [x] TASK-025: `compass decisions <doc>` - complexity: M, depends_on: TASK-024, files: [plugin/cli/commands/decisions.py, plugin/cli/maincli.py, plugin/cli/tests/test_commands.py], decisions: [ADR-007-decision-coverage-mechanism/D-06, SPEC-007-decision-coverage-tracing/D-01]
